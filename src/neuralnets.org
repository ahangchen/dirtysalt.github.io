...
** [[file:./images/nn-class-lec4.pdf][Lecture4]] (神经网络输出函数)
...
** [[file:./images/nn-class-lec6.pdf][Lecture6]] (mini-batch梯度下降)
...
** Lecture10 (训练NN中避免overfitting-1)
