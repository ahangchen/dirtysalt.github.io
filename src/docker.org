...
可以参考创建 [[https://github.com/dirtysalt/tomb/blob/master/misc/dockerfiles/mysql/Dockerfile][mysql]] 和 [[https://github.com/dirtysalt/tomb/blob/master/misc/dockerfiles/redis/Dockerfile][redis]] 镜像的Dockerfile.
