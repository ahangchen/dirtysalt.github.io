...
我写了个 [[https://github.com/dirtysalt/tomb/tree/master/kaggle/digit-recognizer][示例]] 来解决Kaggle上 [[http://www.kaggle.com/c/digit-recognizer][手写数字识别]] 问题，prototxt是在examples/mnist基础上稍作修改的（增加了一个dropout）。
